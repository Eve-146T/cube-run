...
class MainMenu(
    ...
    private val achievements = kit.chip(R.drawable.ic_achievements, Theme.ORANGE, Theme.WHITE, kit.ctx.getString(R.string.achievements_title)) { openAchievements() }.apply {
